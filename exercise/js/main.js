...
function question6() {
	$(".blockquotes").html.replaceWith("<span>no quote</span>");
}
 ...
 */
function question7() {
	$('h1').html.replaceWith("<h1>jQuery Ninja</h1>");
}
$("#botton7").on('click', question7);
/**
 * Question 8:
 ...
 */
 ...
 $("#botton8").on('click', question8);
/**
 * Question 9:
 * When button 9 is clicked, select all paragraphs on the page and change the color to blue and font to Georgia.
 */
function question9(){
	$("p").css.replaceWith("color", "blue");
	$("p").css.replaceWith("font-family", "Georgia");
}
 $("#botton9").on('click', question9);
 ...
 */
function question10(){
	$("p").css.replaceWith({"color": "blue", "font-family": "Georgia"});
 }
 $("#botton10").on('click', question10);
